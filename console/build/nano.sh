...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-console:nano-0.1.0-b3

echo "   ********************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-console:nano-0.1.0-b3"
echo "   ****"
echo "   ********************************************"
echo
docker build \
  ...
  --file Dockerfile \
  \
  -t ewsdocker/ldc-console:nano-0.1.0-b3  .
[[ $? -eq 0 ]] ||
 {
...
echo "   ***********************************************"
echo "   ****"
echo "   **** created ldc-console-nano-0.1.0-b3 container"
echo "   ****"
echo "   ***********************************************"
echo
