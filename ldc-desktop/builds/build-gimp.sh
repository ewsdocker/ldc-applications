...
echo "   ********************************************"
echo
docker stop ldc-desktop-gimp-0.1.0-b1
docker rm ldc-desktop-gimp-0.1.0-b1
...
docker rmi ewsdocker/ldc-desktop:gimp-0.1.0-b1

# ===========================================================================
#
#    ldc-desktop:gimp-0.1.0-b1
#
# ===========================================================================

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-desktop:dgimp-fortran-jdk11-fortran-jdk11-gtk3-0.1.0-b1"
echo "   ****"
echo "   ***************************************************"
echo
...
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-desktop:gimp-0.1.0-b1 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-desktop-gimp-0.1.0-b1"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
      ...
      \
      -e LRUN_APP="gimp" \
      --name=ldc-desktop-gimp-0.1.0-b1 \
    ewsdocker/ldc-desktop:gimp-0.1.0-b1
[[ $? -eq 0 ]] ||
 {
 	echo "create container ldc-desktop-gimp-0.1.0-b1 failed."
 	exit 1
 }
...
echo "   ****************************************************************"
echo "   ****"
echo "   **** ldc-desktop:gimp-0.1.0-b1 successfully installed."
echo "   ****"
echo "   **** run with "
echo "   ****    docker start ldc-desktop-gimp-0.1.0-b1"
echo "   ****"
echo "   ****************************************************************"
echo
echo
