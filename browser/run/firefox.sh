...
echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-browser-firefox-0.1.0-b3"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
  --name=ldc-browser-firefox-0.1.0-b3 \
ewsdocker/ldc-browser:firefox-0.1.0-b3
[[ $? -eq 0 ]] ||
 {
 	echo "build container ldc-browser-firefox-0.1.0-b3 failed."
 	exit 2
 }
