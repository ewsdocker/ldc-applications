...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-games:mahjongg-0.1.0-b4

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-games:mahjongg-0.1.0-b4"
echo "   ****"
echo "   ***************************************************"
echo
docker build \
  ...
  \
  --file Dockerfile \
 -t ewsdocker/ldc-games:mahjongg-0.1.0-b4 .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-games:mahjongg-0.1.0-b4 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** created ldc-games-mahjongg-0.1.0-b4"
echo "   ****"
echo "   ***********************************************"
echo
