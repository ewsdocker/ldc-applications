...
echo "   ********************************************"
echo
docker rm ldc-eclipse-php-0.1.0-b2
...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-eclipse:php-0.1.0-b2

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-eclipse:php-0.1.0-b2"
echo "   ****"
echo "   ***************************************************"
echo
docker build \
  ...
  \
  --file Dockerfile \
-t ewsdocker/ldc-eclipse:php-0.1.0-b2  .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-eclipse:php-0.1.0-b2 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-eclipse-php-0.1.0-b2"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
   ...
   \
   --name=ldc-eclipse-php-0.1.0-b2 \
 ewsdocker/ldc-eclipse:php-0.1.0-b2
[[ $? -eq 0 ]] ||
 {
 	echo "build container ldc-eclipse-php-0.1.0-b2 failed."
 	exit 2
 }
