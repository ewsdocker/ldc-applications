...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-eclipse:java${ldcvers}${ldcextv}

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-eclipse:java${ldcvers}${ldcextv}"
echo "   ****"
echo "   ***************************************************"
echo
docker build \
  ...
  --network="${pkgnet}" \
  --file Dockerfile \
-t ewsdocker/ldc-eclipse:java${ldcvers}${ldcextv}  .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-eclipse:java${ldcvers}${ldcextv} failed."
 	exit 1
 }
